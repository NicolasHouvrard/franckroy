...
export class CocktailService {
  ...
  public addCoctail(cocktail: Cocktail): Observable<Cocktail> {
    return this.http.post<Cocktail>("https://restapi.fr/api/coctails", cocktail).pipe(
...
public editCocktail(cocktailId: string, editedCocktail: Cocktail): Observable<Cocktail> {
    console.log("id du cocktail");
    
    console.log(cocktailId);
    
    return this.http.patch<Cocktail>(
      `https://restapi.fr/api/coctails/${cocktailId}`,
       editedCocktail)
       .pipe(
         tap((savedCocktail: Cocktail) => {
          const value = this.cocktails$.value;
...
public fetchCocktails(): Observable<Cocktail[]> {
  return this.http.get("https://restapi.fr/api/coctails").pipe(
  ...
  public seed() {
    this.http.post('https://restapi.fr/api/coctails',  {
      name: "Mojito",
      img:
